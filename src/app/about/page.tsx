  ...
  return (
    ...
    >
      ...
      <div className={"h-full overflow-scroll"}>
        ...
        <div
          className={
            "p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64"
          }
        >
          {/* BIOGRAPHY CONTAINER */}
            ...
            <div className={""}>
              ...
              <div className={"flex justify-between h-48"}>
                ...
                <div className={"w-1/3"}>
                  ...
                  <div
                    className={
                      "bg-white p-3 font-semibold rounded-b-lg rounded-s-lg"
                    }
                  >
                ...
                <div className={"w-1/6"}>
                  ...
                  <div className="w-1 h-full bg-gray-600 rounded relative">
                    ...
                    <div
                      className={
                        "absolute w-5 h-5 rounded-full ring-4 ring-red-400 bg-white -left-2"
                      }
                    ></div>
                  </div>
                </div>
